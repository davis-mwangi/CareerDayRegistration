package com.safaricom.cdr;

import com.safaricom.cdr.entities.Job;
...
@SpringBootTest(classes = CdrApplication.class, webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
